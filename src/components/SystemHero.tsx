...
import { Network, Cpu, Globe, Zap, Database, Lock } from 'lucide-react';
    ...
    return (
        <section ref={targetRef} className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-black pb-20 pt-32">
            ...
            >
                ...
                >
                    Uma infraestrutura viva que conecta <span className="text-white font-medium">marketing, operações e vendas</span> num único fluxo contínuo.
                ...
                >
                    {[
                        { icon: Network, label: "Rede Neural", color: "text-avenix-cyan", border: "border-avenix-cyan/20" },
                        { icon: Database, label: "Memória Total", color: "text-avenix-orange", border: "border-avenix-orange/20" },
                        { icon: Zap, label: "Tempo Real", color: "text-white", border: "border-white/20" },
                        { icon: Lock, label: "Criptografado", color: "text-avenix-cyan", border: "border-avenix-cyan/20" },
                    ].map((item, i) => (
            ...
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2">
                ...
                >
                    ...
                    <span className="text-[10px] uppercase tracking-widest opacity-90">Explorar Sistema</span>
                </motion.div>
            </div>
        </section>
    );
